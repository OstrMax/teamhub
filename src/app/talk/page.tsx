            ...
            <div className="px-4 py-3" style={{ animation: "fadeIn 0.3s ease-out" }}>
              ...
              <div className="mt-2 rounded-[12px] p-2" style={{ backgroundColor: "var(--th-call-card-bg)", border: "1px solid var(--th-call-card-border)" }}>
                ...
                <div className="flex items-center gap-2">
                  {/* Blind dropdown */}
                  <button data-tip="Blind transfer" className="flex items-center gap-1 rounded-full px-3 py-1.5 transition-colors active:scale-95" style={{ backgroundColor: "var(--th-call-btn-bg)", color: "var(--th-call-btn-text)" }}>
                  ...
                  {/* Hold */}
                  <button data-tip="Hold call" className="w-9 h-9 rounded-full flex items-center justify-center transition-colors active:scale-95" style={{ backgroundColor: "var(--th-call-action-bg)" }}>
                  ...
                  {/* Park */}
                  <button data-tip="Park call" className="w-9 h-9 rounded-full flex items-center justify-center transition-colors active:scale-95" style={{ backgroundColor: "var(--th-call-action-bg)" }}>
