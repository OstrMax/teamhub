...
const allApps = [
  ...
  { name: "Appointment Scheduler", desc: "Schedule an easy and efficient way for you to schedule your...", action: "INSTALL", color: "#2CAD43", iconType: "calendar" as const },
  ...
  { name: "Call Recording Pro", desc: "Advanced recording with AI transcription and analytics", action: "INSTALL", color: "#3B82F6", iconType: "ai" as const },
  { name: "Contact Sync", desc: "Sync contacts across all your connected platforms", action: "VIEW", color: "#EC4899", iconType: "calendar" as const },
];
