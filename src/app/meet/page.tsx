    ...
    <>
      ...
      <div className="flex items-center justify-center gap-16 py-4">
        <button onClick={() => onJoinMeeting("New Meeting")} className="flex flex-col items-center gap-2 group">
          <div className="w-16 h-[63px] rounded-[20px] flex items-center justify-center group-hover:shadow-lg group-active:scale-95 transition-all" style={{ background: "var(--th-meet-btn-new)", border: "1px solid var(--th-meet-btn-border)" }}>
        ...
        <button onClick={() => onJoinMeeting("Meeting Room")} className="flex flex-col items-center gap-2 group">
          <div className="w-16 h-[63px] rounded-[20px] flex items-center justify-center group-hover:shadow-lg group-active:scale-95 transition-all" style={{ background: "var(--th-meet-btn-alt)", border: "1px solid var(--th-meet-btn-border)" }}>
